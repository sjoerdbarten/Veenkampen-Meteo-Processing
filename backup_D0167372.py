...
newpath = os.path.join(w_path,"D0167372_"+str(today))
newpath_m = os.path.join(m_path,"backup_temp_D0167372")
...
sync(os.path.join(m_path,"backup_temp_D0167372"), os.path.join(newpath), 'sync')
